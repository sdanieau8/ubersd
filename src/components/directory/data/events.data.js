    ...
    items: [
      {
        ...
        linkUrl: 'https://pechangaarenasd.com/'
      },
      {
        id: 52,
        name: 'Viejas Arena',
        address: '5500 Canyon Crest Dr',
        mapLink: 'http://maps.apple.com/?address=5500,Canyon+Crest+Dr,San+Diego,California',
        linkUrl: 'http://www.viejasarena.org/'
      },
      {
        id: 53,
        name: 'Petco Park',
        ...
        linkUrl: 'https://www.mlb.com/padres/tickets/concerts'
      },
      {
        id: 54,
        name: 'The Rady Shell',
        address: '222 Marina Park Way',
        mapLink: 'http://maps.apple.com/?address=222,Marina+Park+Way,San+Diego,California',
        linkUrl: 'https://www.theshell.org/'
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 55,
        name: 'College Sports',
        type: 'San Diego State University',
